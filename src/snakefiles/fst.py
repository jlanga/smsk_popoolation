def get_window_size(wildcards):
    return params["popoolation2"]["fst_sliding"]["window_size"]


def get_step_size(wildcards):
    return params["popoolation2"]["fst_sliding"]["step_size"]


def get_min_covered_fraction(wildcards):
    return params["popoolation2"]["fst_sliding"]["min_covered_fraction"]
...
def get_min_count(wildcards):
    return params["popoolation2"]["fst_sliding"]["min_count"]
