...
pod2usage( -msg => "Could not find output file", -verbose => 1 )
    unless $outputFile;
...
print $ofh
    "# this table contains the average non-synonymous length of a codon\n";
print $ofh
    "# this value is necessary to calculate the length normalised Tajima's pi (division by the length of a sequence)\n";
print $ofh
    "# this table has been automatically created using a transversion penalty of: $transversion_penalty\n";
print $ofh "#";
