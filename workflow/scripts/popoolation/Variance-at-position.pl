...
# in case this is the last position of the gene, handle it immediately; print it
        if ( $pos == $genehash->{$gene}{last} ) {
            Utility::handle_completed_gene( $ofh, $genehash, $gene,
                $varianceCalculator, $measure, $snpwriter );
        }
...

{
    ...
    sub test_read_gtf {
        ...
        is( scalar( @{ $gh->{g1}{snps} } ),
            0, "test gtf_reader; length of snps is ok" );
        ...
        is( $dec->( "2L", "1" )[0],
            "g1", "test gtf_reader: correct gene at given position" );
        is( $dec->( "2L", "2" )[0],
            "g1", "test gtf_reader: correct gene at given position" );
        is( $dec->( "2L", "3" )[0],
            "g1", "test gtf_reader: correct gene at given position" );
        ...
        is( $dec->( "2L", "10" )[0],
            "g1", "test gtf_reader: correct gene at given position" );
        is( $dec->( "2L", "11" )[0],
            "g2", "test gtf_reader: correct gene at given position" );
        is( $dec->( "2L", "12" )[0],
            "g2", "test gtf_reader: correct gene at given position" );
        is( $dec->( "2L", "9" )[1],
            "g2", "test gtf_reader: correct gene at given position" );
        is( $dec->( "2L", "10" )[1],
            "g2", "test gtf_reader: correct gene at given position" );
        not_exists( $dec->( "2L", "13" ),
            "test gtf_reader: correct no gene at given position" );
        not_exists( $dec->( "2L", "14" ),
            "test gtf_reader: correct no gene at given position" );

        is( $dec->( "2R", "1" )[0],
            "g3", "test gtf_reader: correct gene at given position" );
        is( $dec->( "2R", "2" )[0],
            "g3", "test gtf_reader: correct gene at given position" );
        is( $dec->( "2R", "3" )[0],
            "g3", "test gtf_reader: correct gene at given position" );
        ...
        not_exists( $dec->( "2R", "9" ),
            "test gtf_reader: correct no gene at given position" );
        not_exists( $dec->( "2R", "10" ),
            "test gtf_reader: correct no gene at given position" );

        is( $dec->( "2R", "11" )[0],
            "g4", "test gtf_reader: correct gene at given position" );
        is( $dec->( "2R", "12" )[0],
            "g4", "test gtf_reader: correct gene at given position" );
        is( $dec->( "2R", "13" )[0],
            "g4", "test gtf_reader: correct gene at given position" );
