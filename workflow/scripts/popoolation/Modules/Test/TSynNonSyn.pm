{
    ...
    sub test_get_codon_changes {
        ...
        is( $tr->{codon}, "TCA",
            "calculating amino acid change; original codon correct" );
        is( $tr->{chr}, "2R",
            "calculating amino acid change, chromosome is correct" );
        is( $tr->{count_snps}, 1,
            "calculating amino acid change, snp count is correct" );
        is( $tr->{cc}[0]{codon},
            "TCA", "calculating amino acid change; original codon correct" );
        is( $tr->{cc}[0]{mcodon},
            "ACA", "calculating amino acid change; modified codon correct" );
        is( $tr->{cc}[0]{aa},
            "S",
            "calculating amino acid change; original amino acid correct" );
        is( $tr->{cc}[0]{maa},
            "T",
            "calculating amino acid change; modified amino acid correct" );
        ...
        is( $tr->{cc}[0]{strand},
            "+", "calculating amino acid change; strand ok" );
        is( $tr->{cc}[0]{syn},
            0, "calculating amino acid change; synonymous determination ok" );
        is( $tr->{cc}[0]{cstart},
            3, "calculating amino acid change; codon start is ok" );

        $tr = $pts->next();
        get_codon_changes( $tr, $codonTable );
        is( $tr->{codon}, "CGT",
            "incorporating snp into codon; original codon correct" );
        is( $tr->{chr}, "2R",
            "calculating amino acid change, chromosome is correct" );
        is( $tr->{count_snps}, 1,
            "calculating amino acid change, snp count is correct" );
        is( $tr->{cc}[0]{codon},
            "CGT", "calculating amino acid change; original codon correct" );
        is( $tr->{cc}[0]{mcodon},
            "CCT", "calculating amino acid change; modified codon correct" );
        is( $tr->{cc}[0]{aa},
            "R",
            "calculating amino acid change; original amino acid correct" );
        is( $tr->{cc}[0]{maa},
        ...
        is( $tr->{count_snps}, 1,
            "calculating amino acid change, snp count is correct" );
        is( $tr->{cc}[0]{codon},
            "ACA", "calculating amino acid change; original codon correct" );
        is( $tr->{cc}[0]{mcodon},
            "ACG", "calculating amino acid change; modified codon correct" );
        is( $tr->{cc}[0]{aa},
            "T",
            "calculating amino acid change; original amino acid correct" );
        is( $tr->{cc}[0]{maa},
        ...
        is( $tr->{cc}[0]{strand},
            "+", "calculating amino acid change; strand ok" );
        is( $tr->{cc}[0]{syn},
            1, "calculating amino acid change; synonymous determination ok" );
        ...
        is( $tr->{cc}[0]{codon},
            "ACA", "calculating amino acid change; original codon correct" );
        is( $tr->{cc}[0]{mcodon},
            "AAA", "calculating amino acid change; modified codon correct" );
        is( $tr->{cc}[0]{aa},
            "T",
            "calculating amino acid change; original amino acid correct" );
        is( $tr->{cc}[0]{maa},
        ...
        is( $tr->{cc}[0]{codon},
            "ACA", "calculating amino acid change; original codon correct" );
        is( $tr->{cc}[0]{mcodon},
            "TCA", "calculating amino acid change; modified codon correct" );
        is( $tr->{cc}[0]{aa},
            "T",
            "calculating amino acid change; original amino acid correct" );
        is( $tr->{cc}[0]{maa},
        ...
        is( $tr->{cc}[0]{codon},
            "CGT", "calculating amino acid change; original codon correct" );
        is( $tr->{cc}[0]{mcodon},
            "CGG", "calculating amino acid change; modified codon correct" );
        is( $tr->{cc}[0]{aa},
            "R",
            "calculating amino acid change; original amino acid correct" );
        is( $tr->{cc}[0]{maa},
        ...
        is( $tr->{cc}[2]{codon},
            "CGT", "calculating amino acid change; original codon correct" );
        is( $tr->{cc}[2]{mcodon},
            "GGT", "calculating amino acid change; modified codon correct" );
        is( $tr->{cc}[2]{aa},
            "R",
            "calculating amino acid change; original amino acid correct" );
        is( $tr->{cc}[2]{maa},
    ...
    sub test_load_cds {
        ...
        not_exists( $res->{'3R'}{'3'},
            "CDS loader correct, no frame at position" );
        ...
        not_exists( $res->{'2R'}{'12'},
            "CDS loader correct, no frame at position" );

        $str = "2R\tmaker\tCDS\t3\t11\t.\t+\t0\n"
            . "2R\tmaker\tCDS\t3\t7\t.\t+\t2\n";
        $res = load_cds_gtf( \$str );
        not_exists( $res->{'2R'}{'2'},
            "CDS loader correct, no frame at position" );
