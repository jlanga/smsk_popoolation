{
    ...
    sub test_PileupTripletSlider {
        ...
        is( $e->{valid_coverage}, "1",
            "PileupTriplet slider; Validity is ok" );
        is( $e->{valid_consensus}, "1",
            "PileupTriplet slider; Validity is ok" );
        ...
        is( $e->{pileup}[0]{pos},
            "3", "PileupTriplet slider; Position is ok" );
        is( $e->{pileup}[1]{pos},
            "4", "PileupTriplet slider; Position is ok" );
        is( $e->{pileup}[2]{pos},
            "5", "PileupTriplet slider; Position is ok" );
        ...
        is( $e->{pileup}[0]{pos},
            "8", "PileupTriplet slider; Position is ok" );
        is( $e->{pileup}[1]{pos},
            "9", "PileupTriplet slider; Position is ok" );
        is( $e->{pileup}[2]{pos},
            "10", "PileupTriplet slider; Position is ok" );
        is( $e->{count_snps}, "0", "PileupTriplet slider; SNP count is ok" );
        ...
        is( $e->{valid_coverage}, "0",
            "PileupTriplet slider; Validity is ok" );
        is( $e->{valid_consensus}, "0",
            "PileupTriplet slider; Validity is ok" );
