{
    ...
    sub _calculatePvalue {
        ...
        foreach my $d (@$data) {
            ...
            my ( $major, $minor )
                = MajorAlleles::get_major_minor_alleles($cosa);
            ...
            my $snp_pvalue
                = FET::_get_snpwise_pvalue( $index, $snp, $major, $minor,
                $popcount );
    ...
    sub _get_snpwise_pvalue {
        ...
        foreach my $id (@$index) {
            ...
            ( $major1, $major2, $minor1, $minor2 ) = (
                $snp->{$a}->{$major}, $snp->{$b}->{$major},
                $snp->{$a}->{$minor}, $snp->{$b}->{$minor}
            );

            $pvalue = FET::_get_Fisher_twotailed_pvalue( $major1, $major2,
                $minor1, $minor2 );
