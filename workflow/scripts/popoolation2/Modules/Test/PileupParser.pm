{
    ...
    sub test_basicmpileupparser {
        ...
        $res = $pp->(
            "dralala\t2\tN\t5\tATCGATCGATCG\tZYXWVUTSRQPO\t10\tAAAA\tZZZZ\t");
        is( $res->{chr}, "dralala",
            "basic mpileup parser; refchromosome is OK" );
        is( $res->{pos}, 2, "basic mpileup parser; position is OK" );
        is( $res->{refc}, "N",
            "basic mpileup parser; reference character is OK" );
        ...
        is( $res->{entries}[0]{del},
            0, "basic mpileup parser; del count is OK" );
        ...
        is( $res->{entries}[2]{del},
            0, "basic mpileup parser; del count is OK" );

        $res
            = $pp->("chr2\t10\tT\t3\tTTTGG\tZZZZZ\t0\t*\t*\t4\tAAAAT\tZZZZZ");
        is( $res->{chr}, "chr2",
            "basic mpileup parser; refchromosome is OK" );
        is( $res->{pos}, 10, "basic mpileup parser; position is OK" );
        is( $res->{refc}, "T",
    ...
    sub test_parsePileup {
        ...
        $res
            = $pp->(
            "dralala\t2\tN\t5\tA+12AAAAAAAAAAAAT^FC\$GATCGATCG\tZYXWVUTSRQPO"
            );
        is( $res->{eucov}, 6, "parsePileup; coverage is ok" );
        is( $res->{A},     2, "parsePileup; A count is ok" );
        is( $res->{T},     2, "parsePileup; T count is ok" );
        ...
        $res = $pp->(
            "dralala\t2\tN\t5\tA+2AAT^FC\$G-3CCCATCGATCG\tZYXWVUTSRQPO");
        is( $res->{eucov}, 6, "parsePileup; coverage is ok" );
        is( $res->{A},     2, "parsePileup; A count is ok" );
        is( $res->{T},     2, "parsePileup; T count is ok" );
        is( $res->{C},     2, "parsePileup; C count is ok" );
        ...
        $res
            = $pp->(
            "dralala\t2\tN\t5\tA-12CCCCCCCCCCCCT^FC\$GATCGATCG\tZYXWVUTSRQPO"
            );
        is( $res->{eucov}, 6, "parsePileup; coverage is ok" );
        is( $res->{A},     2, "parsePileup; A count is ok" );
        is( $res->{T},     2, "parsePileup; T count is ok" );
    ...
    sub test_parseExtendedPileup() {
        ...
        $res = $pp->("2L\t90140\tN\t9\tCCccCcCC^FC\t[aaba`aaa");
        is( $res->{consc}, "C",
            "extended parsePileup; consensus character is ok" );
        is( $res->{consc_confidence},
            1, "extended parsePileup; confidence is ok" );
        ...
        is( $res->{consc}, "C",
            "extended parsePileup; consensus character is ok" );
        is( $res->{consc_confidence},
            0.5, "extended parsePileup; confidence is ok" );
