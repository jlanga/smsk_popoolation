...
#4	411770	1	1.000	29.0	1:2=-1.36490123	1:3=0.00000000	1:4=-0.26843293	2:3=-1.36957767	2:4=-1.23044410	3:4=0.00000000
        ...
        is( $pvalue->{"1:2"}, 0.59479996122477,
            "Fisher exact test for population1:population2 p-value is correct"
        );
        is( $pvalue->{"1:3"}, 0.534375091868129,
            "Fisher exact test for population1:population2 p-value is correct"
        );
        is( $pvalue->{"2:3"}, 6.26812853259637e-16,
            "Fisher exact test for population1:population2 p-value is correct"
        );
        ...
        $pvalue = FET::_calculatePvalue( $data, $popcount );
        is( $pvalue->{"1:3"}, 1.24715461488113,
            "Fisher exact test for population1:population2 p-value is correct"
        );
        is( $pvalue->{"2:3"}, 0.716431430886714,
            "Fisher exact test for population1:population2 p-value is correct"
        );
        ...
        $pvalue = FET::_calculatePvalue( $data, $popcount );
        is( $pvalue->{"1:2"}, 0.260619437416786,
            "Fisher exact test for population1:population2 p-value is correct"
        );
        is( $pvalue->{"2:3"}, 0.302119819277042,
            "Fisher exact test for population1:population2 p-value is correct"
        );
        ...
        $pvalue = FET::_calculatePvalue( $data, $popcount );
        is( $pvalue->{"1:2"}, 0.514589572491402,
            "Fisher exact test for population1:population2 p-value is correct"
        );
        is( $pvalue->{"2:3"}, 0.308019523704544,
            "Fisher exact test for population1:population2 p-value is correct"
        );
        ...
        $pvalue = FET::_calculatePvalue( $data, $popcount );
        is( $pvalue->{"1:3"}, 0.818325717402551,
            "Fisher exact test for population1:population2 p-value is correct"
        );
        is( $pvalue->{"2:3"}, 0.304056450294169,
            "Fisher exact test for population1:population2 p-value is correct"
        );
