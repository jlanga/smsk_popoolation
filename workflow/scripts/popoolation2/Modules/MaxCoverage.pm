{
    ...
    sub get_max_coverage {
        ...
        if ( $usermaxcov =~ /%$/ ) {
            $usermaxcov =~ s/%$//;
            $maxcoverages
                = _get_maxcov_bypercentoutlier( $syncfile, $usermaxcov,
                $popcount );
        }
        elsif ( $usermaxcov =~ /,/ ) {
        ...
        die
            "Number of populations $popcount does not agree with number of maximum coverages $tempcount"
    ...
    sub _get_maxcov_bypercentoutlier {
        ...
        print
            "Computing maximum coverage cutoffs from the empirical distributions of coverages\n";
        ...
        print
            "Result: '--max-coverage $pcoutlier%' is equivalent to '--max-coverage $maxstr'\n";
